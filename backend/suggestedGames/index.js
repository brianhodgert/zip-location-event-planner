...
const GetSuggestedGames = require("./getSuggestedGames");
const getSuggestedGames = new GetSuggestedGames(dbService);
...
module.exports.handler = async (event, context, callback) => {
  ...
  if (event.httpMethod == "GET") {
    response = await getSuggestedGames.getSuggestedGames(
      profile.email,
